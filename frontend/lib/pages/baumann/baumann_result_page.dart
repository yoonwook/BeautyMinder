    ...
    return Container(
      child: Center(
        child: Column(
          ...
          children: [
            SizedBox(height: 10),
            Text('Skin Type: ${widget.resultData.data['skinType'] ?? 'N/A'}'),
            SizedBox(height: 10),
            _descriptionType(),
            SizedBox(height: 10),
            _spiderChart(),
            SizedBox(height: 10),
            // Text('색소침착도: ${widget.resultData.data['scores']['pigmentation'] ?? 'N/A'}'),
            // Text('유수분 밸런스: ${widget.resultData.data['scores']['hydration'] ?? 'N/A'}'),
            // Text('탄력: ${widget.resultData.data['scores']['elasticity'] ?? 'N/A'}'),
            // Text('수분 보유력: ${widget.resultData.data['scores']['moistureRetention'] ?? 'N/A'}'),
            // Text('민감도: ${widget.resultData.data['scores']['sensitivity'] ?? 'N/A'}'),
    ...
    return Center(
      child: RadarWidget(
        radarMap: RadarMapModel(
          legend: [
            LegendModel('결과',const Color(0XFF0EBD8D)),
          ],
          indicator: [
